...
class Timecourse(object):
    ...
    def plot(self, species_names: Optional[List[str]] = None, is_scatter: bool = False,
             **kwargs) -> PlotOptions:
        """Plot the simulated timecourse for species.
        ...
        is_scatter : bool
            If True, plot as scatter plot. If False, plot as line plot.
        **kwargs
